...
class ResumeReadingBook {
  ...
  factory ResumeReadingBook.fromJson(Map<String, dynamic> json) {
    return ResumeReadingBook(
...
class ResumeReadingResponse {
  final List<ResumeReadingBook> books;
  ...
  factory ResumeReadingResponse.fromJson(Map<String, dynamic> json) {
    ...
    return ResumeReadingResponse(books: books);
  }
